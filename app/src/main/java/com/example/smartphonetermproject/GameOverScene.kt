...
class GameOverScene(
    ...
    override val world = World(Layer.entries.toTypedArray()).apply {
        add(
            DrawableSprite(ColorDrawable(Color.argb(190, 0, 0, 0))).apply {
                setCenter(cx, cy)
        ...
        add(GameOverContent(), Layer.CONTENT)
        add(
            RoundRectButton(
                gctx,
                cx,
    ...
    private inner class GameOverContent : IGameObject {
        private val titleLabel = LabelUtil(TITLE_TEXT_SIZE, Color.rgb(255, 80, 80), Paint.Align.CENTER, Typeface.DEFAULT_BOLD)
        ...
        override fun draw(canvas: Canvas) {
            titleLabel.draw(canvas, "GAME OVER", cx, titleY)
    ...
    companion object {
        ...
        private const val TITLE_OFFSET_FROM_TOP = 130f
        private const val SCORE_OFFSET_FROM_TOP = 230f
        private const val CARDS_OFFSET_FROM_TOP = 290f
        private const val EXIT_OFFSET_FROM_TOP = 720f
